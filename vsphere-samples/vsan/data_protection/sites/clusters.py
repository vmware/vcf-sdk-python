...
class Clusters(object):
    ...
    def list(self, site_id):
        return self._snapservice_client.sites.Clusters.list(site_id)
...
def main():
    ...
    clusters = Clusters(clients.snapservice_client)


    print('\nList clusters for : {}'.format(args.site_id))
    print("----------------------------------------")

    clusters = clusters.list(args.site_id)
    print(clusters)
