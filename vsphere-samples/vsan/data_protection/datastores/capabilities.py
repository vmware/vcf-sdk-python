...
class Capabilities(object):
    ...
    def list(self, site_id):
        return self._snapservice_client.sites.datastores.Capabilities.list(site_id)
...
def main():
    ...
    capabilities = Capabilities(clients.snapservice_client)


    print('\nList datastore capabilities for : {}'.format(args.site_id))
    print("----------------------------------------")

    res = capabilities.list(args.site_id)
    print(res)
