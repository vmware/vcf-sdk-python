...
### Running the samples:
    ...
    python vsphere-samples/samples/vsphere/vcenter/vlcm/inventory/bulk_transition/bulk_transition.py -s "<vcenter_ip>" -u "<user>" -p "<password>" -v --entityType "CLUSTER" --entities "domain-c11" "domain-c15"
